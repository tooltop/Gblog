...
class Gblog():
    ...
    def createPostHtml(self,issue):
        ...
        if '<code class="notranslate">Gblog-html' in post_body:
            post_body = re.sub(r'<code class="notranslate">Gblog-html(.*?)</code>', lambda match: html.unescape(match.group(1)), post_body, flags=re.DOTALL)
...
if os.environ.get('GITHUB_EVENT_NAME')!='schedule':
    ...
    readme=readme+"### Powered by :heart: [Gblog](https://github.com/tooltop/Gblog)\r\n"
